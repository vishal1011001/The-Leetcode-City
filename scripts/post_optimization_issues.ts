    ...
    const issues = [
        {
            ...
            labels: ["gssoc 26", "gssoc:approved", "good first issue", "level:intermediate", "type:feature"]
        },
        {
            ...
            labels: ["gssoc 26", "gssoc:approved", "good first issue", "level:advanced", "type:feature"]
        },
        {
