...
import VoidObelisk from "./VoidObelisk";
import DungeonPortal from "./DungeonPortal";
import AstralObservatory from "./AstralObservatory";
import CryptOfEchoes from "./CryptOfEchoes";
import SunkenSanctum from "./SunkenSanctum";
import CodeForge from "./CodeForge";
import ChronoTower from "./ChronoTower";
import SkyTemple from "./SkyTemple";
import FirecrawlBuilding from "./FirecrawlBuilding";
import SolanaBuilding from "./SolanaBuilding";
import CyberStation from "./CyberStation";
import DeveloperPalace from "./DeveloperPalace";
